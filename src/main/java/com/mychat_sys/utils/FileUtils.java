...
public class FileUtils {
	...
	public static MultipartFile fileToWav(String filePath) {
		try {
			// File转换成WavFile
			File file = new File(filePath);
			FileInputStream inputStream = new FileInputStream(file);
			MultipartFile multipartFile = new MockMultipartFile(file.getName(), "wav", "audio/wav", inputStream);
			return multipartFile;
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
